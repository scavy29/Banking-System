        ...
        <div class="container-fluid">
            <a href="index.php">
                <img src="statics\logo.png" alt=""
                    style="height: 80px; margin-left:25px;margin-top:100px;"></a>
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; ">
                        <a class="nav-link text-nowrap" href="sendmoney.php">Send Money</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap active" href="makeatrans.php">View All Customers</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
...
<!-- <div class="table"> -->
            <table class="table table-hover" style="margin-top: 30px;background-color:white;border-radius:2px">
                <thead>
                    <tr>
