...
<body style="background-color:#6f42c1; padding-top:8%;">
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="makeatrans.php">View All Customers</a>
                    </li> 
                    <li class="nav-item" style="margin-left:15px;">
        ...
        <div class="container" style="margin-top:2%;">
            ...
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="sendmoney.php" method="post">
                    ...
                    <br>
                    <input class="btn mybtn btn-outline-light" type="submit" value="Transfer"><br><br>
                    <p style="color:white;"><a href="check_bal.php">Check Balance</a></p>
                </form>
            </div>
        </div>
